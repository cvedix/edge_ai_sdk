...
int main() {
    ...
    auto file_src_0 = std::make_shared<cvedix_nodes::cvedix_file_src_node>("file_src_0", 0, "./cvedix_data/test_video/face2.mp4");
    ...
    auto osd_0 = std::make_shared<cvedix_nodes::cvedix_osd_node_v3>("osd_0", "./cvedix_data/font/NotoSansCJKsc-Medium.otf");
    auto screen_des_0 = std::make_shared<cvedix_nodes::cvedix_screen_des_node>("screen_des_0", 0);

    // create nodes for 2nd pipeline
    auto file_src_1 = std::make_shared<cvedix_nodes::cvedix_file_src_node>("file_src_1", 1, "./cvedix_data/test_video/face2.mp4");
    auto yolo8_seg_detector = std::make_shared<cvedix_nodes::cvedix_trt_yolov8_seg_detector>("yolo8_seg_detector", "./cvedix_data/models/trt/others/yolov8s-seg_v8.5.engine", "./cvedix_data/models/coco_80classes.txt");
    auto osd_1 = std::make_shared<cvedix_nodes::cvedix_osd_node_v3>("osd_1", "./cvedix_data/font/NotoSansCJKsc-Medium.otf");
    auto screen_des_1 = std::make_shared<cvedix_nodes::cvedix_screen_des_node>("screen_des_1", 1);

    // create nodes for 3rd pipeline
    auto file_src_2 = std::make_shared<cvedix_nodes::cvedix_file_src_node>("file_src_2", 2, "./cvedix_data/test_video/face2.mp4");
    auto yolo8_pose_detector = std::make_shared<cvedix_nodes::cvedix_trt_yolov8_pose_detector>("yolo8_pose_detector", "./cvedix_data/models/trt/others/yolov8s-pose_v8.5.engine");
    auto osd_2 = std::make_shared<cvedix_nodes::cvedix_pose_osd_node>("osd_2");
    ...
    cvedix_utils::cvedix_analysis_board board({file_src_0, file_src_1, file_src_2});
    board.display();
}